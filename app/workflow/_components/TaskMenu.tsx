...
export default function TaskMenu() {
  ...
  return (
    <aside className="w-[340px] min-w-[340px] max-w-[340px] border-r border-gray-200 h-screen flex flex-col overflow-hidden">
      {/* Sticky Header */}
      <div className="p-4 border-b border-gray-200  sticky top-0 z-10 shadow-sm">
...
function TaskMenuBtn({
  ...
  return (
    <Button
      variant="ghost"
      className="w-full justify-start h-12 px-4 py-2  border-l-4 border-transparent hover:border-blue-500 transition-all"
      draggable
