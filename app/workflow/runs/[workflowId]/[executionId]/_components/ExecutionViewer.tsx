        ...
        <div className="flex flex-col gap-2">
          ...
          {params &&
            Object.entries(params).map(([key, value]) => (
              ...
              >
                <p className="text-sm to-muted-foreground flex-1 basis-1/3">
                  {key}
                </p>
                <Input
                  readOnly
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="p-0">
        <Table>
          <TableHeader className="to-muted-foreground text-sm">
            <TableRow>
          ...
          <TableBody>
            {logs.map((log) => (
              <TableRow key={log.id} className="to-muted-foreground">
                <TableCell
                  width={190}
                  className="text-xs to-muted-foreground p-[2px] pl-4"
                >
